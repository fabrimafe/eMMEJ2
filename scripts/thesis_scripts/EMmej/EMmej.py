...
if args['debugmode']:
    ...
    modules_loc = '/home/labs/alevy/guyta/guy_master_project/src' ####  THIS'LL BE REMOVED FROM THE LAST VERSION ####
    scripts_loc = '/home/labs/alevy/guyta/guy_master_project/scripts/EMmej' ####  THIS'LL BE REMOVED FROM THE LAST VERSION ####
    scripts = [f"{scripts_loc}/{i}" for i in 
        ['RMdetector.py', 'Markov_model_operator.py', 
                'EM_operator.py', 'EMmej.py']]
    modules = [f"{modules_loc}/{i}" for i in 
        ['ExpectationMaximization_q.py', 'MicroHomology_module_v3.py',
...
if args['steps'] in ['all', 'PT']: 
    ...
    RMdetector = ["python3", 'RMdetector.py', 
        '-v',f"{args['vcf']}", 
...
if args['steps'] in ['all', 'MM']:
    ...
    Markov_model_operator = [
        "python3", "Markov_model_operator.py", 
