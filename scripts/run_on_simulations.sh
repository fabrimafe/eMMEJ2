...
echo "run RM"
python ./bin/EMmej/RMdetector.py --vcf ${xfolder}/indels.vcf --ref $reference -o ${xfolder}/RMoutput.tsv -w 50 -ic -mhl 4,3,2,1 #3,2,1 #2,1,0 #--anc
echo "MM"
#python ./bin/EMmej/Markov_model_operator.py --vcf ${xfolder}/RMoutput.tsv --ref $reference -p markov -o ${xfolder}/MM_output.tsv
echo "EM"
#python ./bin/EMmej/EM_operator.py --vcf ${xfolder}/RMoutput.tsv --ref $reference -o ${xfolder}/EM_output.tsv -e 1 -mhl 4 -ildt "savitzky_golay" #"uniform" -mhl 2,3,4,0
#python ./bin/EMmej/EM_operator.py --vcf ${xfolder}/RMoutput.tsv --ref $reference -o ${xfolder}/EM_output.tsv -e 1 -mhl 0,2 -ildt "savitzky_golay" -dpol #-c 0.000000001
python ./bin/EMmej/EM_operator.py --vcf ${xfolder}/RMoutput.tsv --ref $reference -o ${xfolder}/EM_output.tsv -e 1 -mhl 4,3,2,1 -ildt "savitzky_golay" #-ildt "full" # -dpol #-c 0.000000001
