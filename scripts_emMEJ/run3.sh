...
echo "run RM"
python ./scripts/EMmej/RMdetector.py --vcf ${xfolder}/indels.vcf --ref $reference -o ${xfolder}/RMoutput.tsv -w 50 -ic -mhl 2 #2,1,0 #--anc
echo "MM"
...
python ./scripts/EMmej/EM_operator.py --vcf ${xfolder}/RMoutput.tsv --ref $reference -o ${xfolder}/EM_output.tsv -e 1 -mhl 2 -ildt "savitzky_golay"
