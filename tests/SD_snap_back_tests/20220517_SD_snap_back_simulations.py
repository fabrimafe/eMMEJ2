...
path_to_data = '/home/labs/alevy/guyta/guy_master_project/results/indels_simulations/simulations_from_Fabrizio/20220517/1957_20220517_main_pipline_output_test1/1957_20220517_MMEJ_detection_formated_data.csv'
# path_to_data = '/home/labs/alevy/guyta/guy_master_project/results/indels_simulations/simulations_from_Fabrizio/20220525/1405_20220525_main_pipline_output_test1/1405_20220525_MMEJ_detection_formated_data.csv'
...
df = pd.read_csv(path_to_data, sep='\t', dtype=Dtypes)
context_window = 1500
problematic_pos = [42456428, 38558982, 31691603, 24689121, 49901057, 45055756,
 22125875, 31034052, 30304994, 40142361, 5776711, 12733106, 22624078, 42581728,
 41856147, 15757402, 28661981, 38351437, 12335055, 31189458, 7396335, 38004915,
 1606943, 6630993, 2929142, 16537725, 12589828, 5649782, 23624325, 30723132,
 17173397, 32545312, 23717602, 35006958, 27538579, 2900013, 9115781, 46772331,
 40828108, 37821875, 35157311, 22660128, 2783337, 119940, 12943232, 44183430,
 830837, 5532643, 30165169, 20303281, 34701280, 25016186, 18366648, 15427726,
 46226042, 25024632, 33750917, 29648570, 6480493, 11707307, 46396624, 35419732,
 23403065, 30020082, 4815209, 11639139, 52969810, 11823312, 25135347, 2612676,
 14170217, 1938031, 31180980, 6851324, 4184013, 31416516, 45968614, 30600579,
 9131461, 49419721, 49629294, 20437248, 42312123, 35342041, 17064741, 23437099,
 28692091,12437343, 41127850, 5486660, 13393793, 23514604, 44936605, 42905437,
 21960358, 40140520, 41086092, 52771, 54027332, 12022673]
# print(df)
df = df.iloc[0:100, :]
# df = df.loc[df['POS'].isin(problematic_pos), :]
...
path_to_output='/home/labs/alevy/guyta/guy_master_project/data/repair_mechanisms_tests_expected_results/SD_snap_back'
filename='20220525_snap_back_test_correct_results.csv'
